            ...
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="{{ action("Admin\AccommListController@index") }}" id="layout1">Accommodation List</a></li>
                            <li><a href="javascript:void;" id="layout1">Amenity List</a></li>
                            <li><a href="javascript:void;" id="layout2">Activity List</a></li>
                            <li><a href="javascript:void;" id="layout2">Room Type List</a></li>
                            <li><a href="javascript:void;" id="layout2">Payment Mode List</a></li>
                            <li><a href="javascript:void;" id="layout2">Surrounding List</a></li>
                        </ul>
                    </li>
                    @endif
