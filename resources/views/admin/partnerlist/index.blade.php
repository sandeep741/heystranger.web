...
<div class="panel panel-white">
    <div class="panel-heading">
        <h6 class="panel-title text-semibold">My Partner</h6>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <ul class="icons-list">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <!--<li><a href="javascript:void;"><i class="icon-pencil7"></i> Edit file</a></li>-->
                                <li><a href="" onclick="event.preventDefault();
                                            document.getElementById('update-form-{{ $data->id }}').submit();"><i class="icon-eye{{ (($data->status == 1) ? "-blocked" : '') }}"></i> {{ (($data->status == 1) ? "In-active" : "Active") }}</a></li>
                                <li class="divider"></li>
                    ...
                    'url' => 'partnerlist/'.(isset($data) && !empty($data) ? $data->id : ''),
                    'autocomplete' => 'off',
