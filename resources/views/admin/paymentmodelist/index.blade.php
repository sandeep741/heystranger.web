...
<div class="heading-btn-group">
    <a href="{{ route('paymentmodelist.create') }}" class="btn btn-success"><i class="icon-comment-discussion position-left"></i> Add New</a>
</div>  
<br>
...
<div class="panel panel-white">
    <div class="panel-heading">
        <h6 class="panel-title text-semibold">My Payment Mode</h6>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <ul class="icons-list">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="{{ route('paymentmodelist.edit', ['id' => $data->id]) }}"><i class="icon-pencil7"></i> Edit file</a></li>
                    ...
                    'url' => 'paymentmodelist/'.(isset($data) && !empty($data) ? $data->id : ''),
                    'autocomplete' => 'off',
