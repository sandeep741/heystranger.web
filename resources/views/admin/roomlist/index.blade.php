...
<div class="heading-btn-group">
    <a href="{{ route('roomlist.create') }}" class="btn btn-success"><i class="icon-comment-discussion position-left"></i> Add New</a>
</div>  
<br>
...
<div class="panel panel-white">
    <div class="panel-heading">
        <h6 class="panel-title text-semibold">My Room</h6>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    'url' => 'roomlist/'.(isset($data) && !empty($data) ? $data->id : ''),
                    'autocomplete' => 'off',
