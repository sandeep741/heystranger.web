                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <input type="text" class="form-control" placeholder="Accommodation Name">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <select class="select">
                                            <option value="CT">Type of Accommodation</option>
                                            <option value="DE">Bed & Breakfast</option>
                                            <option value="DE">Backpackers</option>
                                            <option value="DE">Camping Sites</option>
                                            <option value="DE">Chalets</option>
                                            <option value="DE">Conference Centre</option>
                                            <option value="DE">Guesthouse</option>
                                            <option value="DE">Game Reserve</option>
                                            <option value="DE">Holiday Home</option>
                                            <option value="DE">Hotel</option>
                                            <option value="DE">Lodge</option>
                                            <option value="DE">Nature Reserve</option>
                                            <option value="DE">Student Accommodation</option>
                                            <option value="DE">Tour Guides</option>
                                            <option value="DE">Venue</option>
                                            <option value="DE">Villa</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <select class="select">
                                            ...
                                            <option value="AK">No of Room</option>
