                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    {{Form::select('accom_type',[''=>'Select type of Venue & Conference']+@$arr_accomm->pluck('name','id')->toArray(), null,['class'=>'form-control'])}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9">
                                    ...
                                    @endif
                                    {{ Form::input('hidden', 'type', 'V', ['readonly' => 'readonly']) }}
